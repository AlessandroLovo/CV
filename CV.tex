...
\section*{Education}
  \begin{description}[style=multiline,leftmargin=3cm,align=right]
    ...
    \item[2016-2022]
      ...
      Thesis title: \emph{Interpretability of deep learning probabilistic prediction of extreme heatwaves over France} \\
...
\section*{Volunteering}
  \begin{description}[style=multiline,leftmargin=3cm,align=right]
    \item[Sep 2025]
      Ecological Volunteering @ \emph{SEEDS Iceland}
  \end{description}
...
\section*{Publications}
  \begin{description}[style=multiline,leftmargin=3cm,align=right]
    ...
    \bu \emph{Tackling the Accuracy-Interpretability Trade-off in a Hierarchy of Machine Learning Models for the Prediction of Extreme Heatwaves} \cite{lovoTacklingAccuracyInterpretability2025} \\
    \bu \emph{Gaussian Framework and Optimal Projection of Weather Fields for Prediction of Extreme Events} \cite{mascoloGaussianFrameworkOptimal2025} (I am joint first author)
    \item[2023]
